...
// See also https://github.com/grantseltzer/weaver
// See also https://github.com/goretk/gore
...
//go:noinline
func test_interface(x interface{}) {}
...
//go:noinline
func test_single_return() string {return""}

//go:noinline
func test_multiple_returns() (int, error) {return 0, nil}
...
//go:noinline
func (s *myComplexStruct) String() string {
	return ""
}
